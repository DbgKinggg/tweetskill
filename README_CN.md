...
agent 会问你要 X Bearer Token（在 developer.x.com 免费申请），然后自己去拉推文、分析、写 skill 文件。
...
| LLM 分析   | ~$0.01    | Gemini Flash 最便宜 |

X Bearer Token 在 [developer.x.com](https://developer.x.com) 免费申请，不需要绑信用卡，免费额度够个人用。

费用在你自己账号里，我们不经手你的 token 或付款。
